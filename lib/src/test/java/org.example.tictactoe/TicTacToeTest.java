...
class TicTacToeTest {
    ...
    void testPlayerInabilityToMoveOnOccupiedCell() {
        ...
        game.start();
        game.move(0,0);
        assertThrows(CellOccupiedException.class,() -> game.move(0, 0));
    }
    ...
    void testPlayerInabilityToMoveOutOfBounds() {
        var game = new TicTacToeGame();
        game.start();
        assertThrows(CellOutOfBoundsException.class,() -> game.move(0, 4));
        assertThrows(CellOutOfBoundsException.class,() -> game.getBoard().getPlayer(0, 4));
    }

    @Test
    void testFalseStart() {
        var game = new TicTacToeGame();
        assertThrows(FalseStateException.class,() -> game.move(0,0));
    }
